...
export function NavigateBottomSheet({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pointer-events-auto mx-auto flex w-full max-w-xl flex-col rounded-t-[1.75rem] border border-[#1E293B] bg-[#141C2F]/97 shadow-2xl backdrop-blur-xl",
          snapClass,
        )}
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 pb-4 pt-3">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#10B981]">Drive</p>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            {eco && (
              <span className="inline-flex items-center gap-1 rounded-full bg-[#0F2A1F] px-3 py-1 text-xs font-bold text-[#10B981]">
                <Leaf className="h-3.5 w-3.5" aria-hidden /> {eco}
              </span>
            )}
